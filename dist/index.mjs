...
var FeatureCard = ({ title, subtitle, imageUrl, onClick }) => {
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { style: { position: "relative", height: "100%", width: "100%" }, children: [
        /* @__PURE__ */ jsx("div", { style: { position: "absolute", inset: 0, background: "rgba(0, 0, 0, 0.3)", zIndex: 1 } }),
        /* @__PURE__ */ jsx(
          "img",
          {
            src: imageUrl,
...
var UserIcon = ({ size = 24 }) => /* @__PURE__ */ jsxs("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: [
  /* @__PURE__ */ jsx("path", { d: "M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" }),
  /* @__PURE__ */ jsx("circle", { cx: "12", cy: "7", r: "4" })
] });
var SparklesIcon = ({ size = 24 }) => /* @__PURE__ */ jsxs("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: [
      ...
      children: [
        /* @__PURE__ */ jsxs(
          "header",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("div", { style: { display: "flex", alignItems: "center" }, children: /* @__PURE__ */ jsx("img", { src: BSD_CONFIG.logo, alt: "BSD AI", style: { height: "clamp(4rem, 6vh, 6.25rem)", width: "auto" } }) }),
              isAuthenticated && user ? /* @__PURE__ */ jsx(
                "div",
                {
                  ...
                  children: user.photo ? /* @__PURE__ */ jsx("img", { src: user.photo, alt: user.name || "", style: { width: "100%", height: "100%", objectFit: "cover", borderRadius: "50%" } }) : /* @__PURE__ */ jsx(UserIcon, { size: 20 })
                }
              ) : /* @__PURE__ */ jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsx(SparklesIcon, { size: 20 })
                }
              )
            ]
          }
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("div", { style: { marginBottom: "clamp(1.5rem, 3vh, 2rem)" }, children: /* @__PURE__ */ jsx(
                    "img",
                    {
                  ...
                  /* @__PURE__ */ jsx(
                    "div",
                    {
                      ...
                      children: tags.map((tag, index) => /* @__PURE__ */ jsxs(React.Fragment, { children: [
                        /* @__PURE__ */ jsx("span", { style: { fontSize: "clamp(1rem, 1.5vw, 1.25rem)" }, children: tag }),
                        index < tags.length - 1 && /* @__PURE__ */ jsx("span", { style: { color: "rgba(255,255,255,0.6)" }, children: "|" })
                      ] }, tag))
                    }
                  ),
                  /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "row", gap: "clamp(1.5rem, 3vw, 5rem)", flexWrap: "wrap", justifyContent: "center" }, children: [
                    /* @__PURE__ */ jsx(
                      "button",
                      {
                        ...
                        children: /* @__PURE__ */ jsxs(
                          "span",
                          {
                            ...
                            children: [
                              /* @__PURE__ */ jsxs("span", { style: { display: "flex", alignItems: "center", gap: "clamp(0.5rem, 0.8vw, 0.8rem)" }, children: [
                                /* @__PURE__ */ jsx("img", { src: BSD_CONFIG.icons.news, alt: "", style: { width: "clamp(1rem, 1.5vw, 1.5rem)", height: "clamp(1rem, 1.5vw, 1.5rem)" } }),
                                enterWorkspace
                              ] }),
                              /* @__PURE__ */ jsx("img", { src: BSD_CONFIG.icons.arrowDefault, alt: "", style: { width: "clamp(1rem, 1.5vw, 1.5rem)", height: "clamp(1rem, 1.5vw, 1.5rem)" } })
                            ]
                          }
                        )
                      }
                      ...
                      "button",
                      {
                        ...
                        children: /* @__PURE__ */ jsxs(
                          "span",
                          {
                            ...
                            children: [
                              /* @__PURE__ */ jsxs("span", { style: { display: "flex", alignItems: "center", gap: "clamp(0.5rem, 0.8vw, 0.8rem)" }, children: [
                                /* @__PURE__ */ jsx("img", { src: BSD_CONFIG.icons.agent, alt: "", style: { width: "clamp(1rem, 1.5vw, 1.5rem)", height: "clamp(1rem, 1.5vw, 1.5rem)" } }),
                                designAgent
                              ] }),
                              /* @__PURE__ */ jsx("img", { src: BSD_CONFIG.icons.arrowDefault, alt: "", style: { width: "clamp(1rem, 1.5vw, 1.5rem)", height: "clamp(1rem, 1.5vw, 1.5rem)" } })
                            ]
                  ...
                  /* @__PURE__ */ jsx(
                    "div",
                    {
                      ...
                      children: featureCards.map((card) => /* @__PURE__ */ jsx(
                        FeatureCard,
                        {
                          title: card.title,
...
function BsdToolboxPanel({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("h2", { style: { color: "#fff", marginBottom: 24 }, children: "AI \u5DE5\u5177\u7BB1" }),
        /* @__PURE__ */ jsx(
          "div",
          {
            style: {
            ...
            children: tools.map((tool) => /* @__PURE__ */ jsxs(
              "div",
              {
                onClick: () => onToolSelect?.(tool.id),
                style: {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx("h4", { style: { color: "#fff", margin: 0 }, children: tool.title }),
                  tool.description && /* @__PURE__ */ jsx("p", { style: { color: "rgba(255,255,255,0.6)", margin: "4px 0 0", fontSize: 12 }, children: tool.description })
                ]
              },
              tool.id
            ))
...
export { ARTIST_CONFIG, ARTIST_DEFAULT_QUICK_ACTIONS, ArtistLandingPage, BSD_CONFIG, BSD_DEFAULT_FEATURE_CARDS, BsdLandingPage, BsdToolboxPanel, CONCEPT_CONFIG, CONCEPT_DEFAULT_QUICK_ACTIONS, ConceptDesignLandingPage, DefaultLandingPage, DynamicComponent, clearRegistry, getRegisteredComponents, getRegisteredThemes, getThemeConfig, hasCustomComponent, registerComponent, registerTheme, resolveComponent };
